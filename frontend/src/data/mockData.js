...
export const keluhanOptions = [
  'Sakit Kepala', 'Demam', 'Sakit Perut', 'Luka Ringan', 'Luka Berat',
  'Lelah', 'Pusing', 'Maag', 'Batuk', 'Pilek', 'Mual',
  'Sakit Tenggorokan', 'Sakit Mata', 'Gatal', 'Sesak'
]

export const tindakanOptions = [
  'Istirahat 15 menit', 'Istirahat 30 menit', 'Diberi Paracetamol',
  'Diberi obat maag', 'Dibalut luka', 'Diberi oralit',
  'Kompres dingin', 'Diukur suhu tubuh', 'Diberi madu / air hangat',
  'Dianjurkan sarapan'
]
...
export const dataSekolah = {
  ...
  kepala_sekolah: 'Bapak Ahmad Fauzi, S.Pd.',
